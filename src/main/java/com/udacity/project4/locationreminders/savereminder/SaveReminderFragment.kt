...
class SaveReminderFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.selectLocation.setOnClickListener {
            if (foregroundAndBackgroundLocationPermissionApproved()) {
                ...
                _viewModel.showSnackBar.value = "You need to enable location permissions"
            }
        }
    ...
    private fun addGeofenceForReminder(reminder: ReminderDataItem) {
        if (reminder.id.isNotEmpty()){
            ...
            _viewModel.showSnackBar.value = "Reminder is not complete."
        }
    }
    ...
    private fun checkDeviceLocationSettings(resolve: Boolean = true) {
        ...
        locationSettingsResponseTask.addOnCompleteListener {
            if (it.isSuccessful) {
                //TODO add something to do on complete
                ""
            }
        }
    }
